...
public class ShowListActivity extends AppCompatActivity {
    ...
    ShowListActivity.myadapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layoutName = getResources().getStringArray(R.array.layout_name);
        ...
        ArrayAdapter<String> mAdapter = new ArrayAdapter<>(this, R.layout.list_item,
                layoutName);
    ...
    public class myadapter extends BaseAdapter {
        ...
        public View getView(int arg0, View arg1, ViewGroup arg2) {
            ...
            if (arg1 == null) {
                an_item = new ShowListActivity.View_An_Item();
                ...
                an_item = (ShowListActivity.View_An_Item) arg1.getTag();
